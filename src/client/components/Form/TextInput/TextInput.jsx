...
const TextInput = ({ name, register, error, label, ...rest }) => (
  <div className="max-w-sm">
    ...
    <input
      ...
      name={name}
      type="text"
      className=" bg-neutral-50 border-b-2 focus:outline-none focus:border-primary-400  border-primary-300 rounded-sm w-full p-2 text-neutral-700 text-sm leading-tight"
      ref={register}
      {...rest}
    />
