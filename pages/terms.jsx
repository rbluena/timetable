  ...
  <LayoutManager showSidebar>
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <p className="text-base leading-8">
        By accessing and placing an order with <b>Asteyo</b>, you confirm that
      ...
      <p className="text-base leading-8">
        Under no circumstances shall Asteyo team be liable for any direct,
        ...
        inability to use, the materials on this site, even if Asteyo team or an
      ...
      <p className="text-base leading-8">
        Asteyo will not be responsible for any outcome that may occur during the
      ...
      <h1 className="text-3xl py-4 border-b border-neutral-300">License</h1>
      <p className="text-base leading-8">
        Asteyo grants you a revocable, non-exclusive, non-transferable, limited
        license to download, install and use the website strictly in accordance
        with the terms of this Agreement.
      </p>
      <p className="text-base leading-8">
        These Terms & Conditions are a contract between you and Asteyo (referred
        to in these Terms & Conditions as &quot;Asteyo&quot;, &quot;us&quot;,
        &quot;we&quot; or &quot;our&quot;), the provider of the Asteyo website
        and the services accessible from the Asteyo website (which are
        collectively referred to in these Terms & Conditions as the &quot;Asteyo
        Service&quot;).
      </p>
      <p className="text-base leading-8">
        You are agreeing to be bound by these Terms & Conditions. If you do not
        agree to these Terms & Conditions, please do not use the Asteyo Service.
      ...
      <ul className="list-outside pl-6 text-base py-4 list-disc">
        ...
        <li className="pl-2 py-2">
          ...
          computer or any other device that can be used to visit Asteyo and use
          the services.
        </li>
        <li className="pl-2 py-2">
          <b>Service:</b> refers to the service provided by Asteyo as described
      ...
      <ul className="list-outside pl-6 text-base py-4 list-disc">
        ...
        <li className="pl-2 py-2">
          ...
          of copyright or trademark) of Asteyo or its affiliates, partners,
      ...
      <p className="text-base leading-8">
        Thanks for shopping at Asteyo. We appreciate the fact that you like to
      ...
      <p className="text-base leading-8">
        ...
        apply to transactions at Asteyo. We’ll be as brief as our attorneys will
        allow. The main thing to remember is that by placing an order or making
        a purchase at Asteyo, you agree to the terms along with Asteyo&apos;s
        Privacy Policy.
      </p>
      <p className="text-base leading-8">
      ...
      <p className="text-base leading-8">
        ...
        (collectively, &quot;Suggestions&quot;) provided by you to Asteyo with
        respect to the website shall remain the sole and exclusive property of
        Asteyo.
      </p>
      <p className="text-base leading-8">
        Asteyo shall be free to use, copy, modify, publish, or redistribute the
      ...
      <p className="text-base leading-8">
        We&opos;ve updated our Terms & Conditions to provide you with complete
      ...
      <p className="text-base leading-8">
        Asteyo uses &quote;Cookies&quote; to identify the areas of our website
      ...
      <p className="text-base leading-8">
        You acknowledge and agree that Asteyo may stop (permanently or
        temporarily) providing the Service (or any features within the Service)
        to you or to users generally at Asteyo’s sole discretion, without prior
        notice to you. You may stop using the Service at any time. You do not
        need to specifically inform Asteyo when you stop using the Service. You
        acknowledge and agree that if Asteyo disables access to your account,
      ...
      <p className="text-base leading-8">
        Asteyo reserves the right to modify, suspend or discontinue, temporarily
      ...
      <p className="text-base leading-8">
        Asteyo may from time to time provide enhancements or improvements to the
      ...
      <p className="text-base leading-8">
        ...
        the website. You agree that Asteyo has no obligation to (i) provide any
      ...
      <p className="text-base leading-8">
        This Agreement shall remain in effect until terminated by you or Asteyo.
      </p>
      <p className="text-base leading-8">
        Asteyo may, in its sole discretion, at any time and for any or no
      ...
      <p className="text-base leading-8">
        ...
        Asteyo, in the event that you fail to comply with any provision of this
      ...
      <p className="text-base leading-8">
        Termination of this Agreement will not limit any of Asteyo&apos;s rights
      ...
      <p className="text-base leading-8">
        You agree to indemnify and hold Asteyo and its parents, subsidiaries,
        ...
        fees, due to or arising out of your: (a) use of the website; (b)
      ...
      <p className="text-base leading-8">
        ...
        kind. To the maximum extent permitted under applicable law, Asteyo, on
        ...
        limitation to the foregoing, Asteyo provides no warranty or undertaking,
      ...
      <p className="text-base leading-8">
        Without limiting the foregoing, neither Asteyo nor any Asteyo&apos;s
        ...
        content, or e-mails sent from or on behalf of Asteyo are free of
      ...
      <p className="text-base leading-8">
        ...
        of Asteyo and any of its suppliers under any provision of this Agreement
      ...
      <p className="text-base leading-8">
        ...
        Asteyo or its suppliers be liable for any special, incidental, indirect,
        ...
        Agreement), even if Asteyo or any supplier has been advised of the
      ...
      <p className="text-base leading-8">
        ...
        notices published by Asteyo on the Services, shall constitute the entire
        agreement between you and Asteyo concerning the Services. If any
        ...
        term, and Asteyo&apos;s failure to assert any right or provision under
        this Agreement shall not constitute a waiver of such right or provision.
        YOU AND Asteyo AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED
      ...
      <h1 className="text-3xl py-4 border-b border-neutral-300">Waiver</h1>
      <p className="text-base leading-8">
      ...
      <p className="text-base leading-8">
        Asteyo reserves the right, at its sole discretion, to modify or replace
      ...
      <p className="text-base leading-8">
        ...
        agree to the new terms, you are no longer authorized to use Asteyo.
      </p>
      ...
      <p className="text-base leading-8">
        The Agreement constitutes the entire agreement between you and Asteyo
        regarding your use of the website and supersedes all prior and
        contemporaneous written or oral agreements between you and Asteyo.
      </p>
      <p className="text-base leading-8">
        You may be subject to additional terms and conditions that apply when
        you use or purchase other Asteyo&apos;s services, which Asteyo will
      ...
      <p className="text-base leading-8">
        ...
        thereof), are owned by Asteyo, its licensors or other providers of such
        material and are protected by TZ and international copyright, trademark,
        ...
        express prior written permission of Asteyo, unless and except as is
      ...
      <p className="text-base leading-8">
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR Asteyo&apos;s INTELLECTUAL PROPERTY
        RIGHTS. The term “dispute” means any dispute, action, or other
        controversy between you and Asteyo concerning the Services or this
      ...
      <p className="text-base leading-8">
        In the event of a dispute, you or Asteyo must give the other a Notice of
        ...
        <a
          ...
          data-cfemail="9bf2f5fdf4dbfae8effee2f4b5f8f4f6b5"
        >
          info@asteyo.com
        </a>{' '}
        Asteyo will send any Notice of Dispute to you by mail to your address if
        we have it, or otherwise to your email address. You and Asteyo will
        ...
        days, you or Asteyo may commence arbitration.
      </p>
      ...
      <p className="text-base leading-8">
        If you and Asteyo don’t resolve any dispute by informal negotiation, any
      ...
      <p className="text-base leading-8">
        ...
        and will become the sole property of Asteyo without any compensation or
        credit to you whatsoever. Asteyo and its affiliates shall have no
      ...
      <h1 className="text-3xl py-4 border-b border-neutral-300">Promotions</h1>
      <p className="text-base leading-8">
        Asteyo may, from time to time, include contests, promotions,
      ...
      <p className="text-base leading-8">
        ...
        of Asteyo. Asteyo will be entitled to injunctive or other equitable
        relief (without the obligations of posting any bond or surety) in the
        event of any breach or anticipatory breach by you. Asteyo operates and
        controls the Asteyo Service from its offices in TZ. The Service is not
        ...
        the Asteyo Service from other locations do so on their own initiative
        ...
        include and incorporate the Asteyo Privacy Policy) contains the entire
        understanding, and supersedes all prior understandings, between you and
        Asteyo concerning its subject matter, and cannot be changed or modified
        by you. The section headings used in this Agreement are for convenience
        only and will not be given any legal import.
      </p>

      <h1 className="text-3xl py-4 border-b border-neutral-300">Disclaimer</h1>
      <p className="text-base leading-8">
        Asteyo is not responsible for any content, code or any other
        imprecision.
      </p>
      <p className="text-base leading-8">
        Asteyo does not provide warranties or guarantees.
      </p>
      <p className="text-base leading-8">
        In no event shall Asteyo be liable for any special, direct, indirect,
      ...
      <p className="text-base leading-8">
        The Asteyo Service and its contents are provided &quot;as is&quot; and
        &quot;as available&quot; without any warranty or representations of any
        kind, whether express or implied. Asteyo is a distributor and not a
        publisher of the content supplied by third parties; as such, Asteyo
        ...
        accessible via the Asteyo Service. Without limiting the foregoing,
        Asteyo specifically disclaims all warranties and representations in any
        content transmitted on or in connection with the Asteyo Service or on
        sites that may appear as links on the Asteyo Service, or in the products
        provided as a part of, or otherwise in connection with, the Asteyo
        ...
        rights. No oral advice or written information given by Asteyo or any of
        ...
        change without notice. Without limiting the foregoing, Asteyo does not
        warrant that the Asteyo Service will be uninterrupted, uncorrupted,
      ...
      <ul className="list-outside pl-6 text-base py-4 list-disc">
        <li className="pl-2 py-2">
          ...
          <a
            href="/cdn-cgi/l/email-protection"
            className="__cf_email__"
            data-cfemail="93fafdf5fcd3f2e0e7f6eafcbdf0fcfe"
          >
            info@asteyo.com
          </a>
        </li>
